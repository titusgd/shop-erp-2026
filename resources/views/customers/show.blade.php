<x-layouts.app active="customers">
    <x-slot:title>檢視客戶</x-slot:title>

    <div
        class="mx-auto max-w-2xl space-y-6"
        data-customer-show-page
    ...
    >
        <section class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div class="min-w-0">
                <h2 class="text-xl font-semibold tracking-tight text-slate-900 sm:text-2xl">檢視客戶</h2>
                <p class="mt-1 text-sm text-slate-500">查看客戶主檔明細。</p>
            </div>
        ...
        <section class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:p-8">
            <div data-customer-detail class="space-y-5">
    ...
    <x-slot:scripts>
        @vite('resources/js/customers-show.js')
    </x-slot:scripts>
</x-layouts.app>
