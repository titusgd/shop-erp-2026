<x-layouts.app active="customers">
    <x-slot:title>客戶管理</x-slot:title>

    <div class="mx-auto max-w-6xl space-y-6" data-customers-page>
        <section class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div class="min-w-0">
                <h2 class="text-xl font-semibold tracking-tight text-slate-900 sm:text-2xl">客戶管理</h2>
                <p class="mt-1 text-sm text-slate-500">新增、修改與刪除客戶資料。</p>
            </div>
            <a
        ...
        <section class="rounded-xl border border-slate-200 bg-white shadow-sm">
            <div class="flex flex-col gap-3 border-b border-slate-200 p-4 sm:flex-row sm:items-center sm:justify-between sm:p-5">
                <div class="relative w-full sm:max-w-xs">
                    <label for="customer-search" class="sr-only">搜尋客戶</label>
                    <input
                        id="customer-search"
                        type="search"
                        data-search
                ...
                <table class="min-w-[48rem] w-full divide-y divide-slate-200 text-left text-sm">
                    <thead class="bg-slate-50 text-slate-500">
                        <tr>
                            ...
                            <th class="whitespace-nowrap px-4 py-3 font-medium sm:px-5">客戶名稱</th>
        ...
        >
            ...
            <div class="relative w-full max-w-md rounded-xl border border-slate-200 bg-white p-5 shadow-xl sm:p-6">
                <h3 id="customer-delete-dialog-title" class="text-lg font-semibold text-slate-900">確認刪除</h3>
