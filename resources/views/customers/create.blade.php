<x-layouts.app active="customers">
    <x-slot:title>新增客戶</x-slot:title>
    ...
    >
        <section class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div class="min-w-0">
                <h2 class="text-xl font-semibold tracking-tight text-slate-900 sm:text-2xl">新增客戶</h2>
                <p class="mt-1 text-sm text-slate-500">填寫客戶基本資料；儲存後將自動產生系統編號。</p>
            </div>
            <a
        ...
        <section class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:p-8">
            <form data-customer-form class="space-y-4">
                ...
                <x-address-location-fields id-prefix="customer" />
