<x-layouts.app active="products">
    <x-slot:title>商品管理</x-slot:title>

    <div class="mx-auto max-w-6xl space-y-6" data-products-page>
        <section class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div class="min-w-0">
                <h2 class="text-xl font-semibold tracking-tight text-slate-900 sm:text-2xl">商品管理</h2>
                <p class="mt-1 text-sm text-slate-500">建立與管理商品主檔，每筆商品需指定分類與單位。</p>
            </div>
            <a
                ...
                <table class="min-w-[52rem] w-full divide-y divide-slate-200 text-left text-sm">
                    <thead class="bg-slate-50 text-slate-500">
                        <tr>
                            ...
                            <th class="whitespace-nowrap px-4 py-3 font-medium sm:px-5">商品名稱</th>
                            <th class="whitespace-nowrap px-4 py-3 font-medium sm:px-5">分類</th>
                            <th class="whitespace-nowrap px-4 py-3 font-medium sm:px-5">單位</th>
        ...
        >
            ...
            <div class="relative w-full max-w-md rounded-xl border border-slate-200 bg-white p-5 shadow-xl sm:p-6">
                <h3 id="product-delete-dialog-title" class="text-lg font-semibold text-slate-900">確認刪除</h3>
