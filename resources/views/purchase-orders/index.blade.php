<x-layouts.app active="purchase-orders">
    <x-slot:title>採購單</x-slot:title>

    <div class="mx-auto max-w-6xl space-y-6" data-purchase-orders-page>
        <section class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div class="min-w-0">
                <h2 class="text-xl font-semibold tracking-tight text-slate-900 sm:text-2xl">採購單</h2>
                <p class="mt-1 text-sm text-slate-500">建立與管理採購單，指定供應商、進貨倉庫與採購明細。</p>
            </div>
            <a
        ...
        <section class="rounded-xl border border-slate-200 bg-white shadow-sm">
            <div class="flex flex-col gap-3 border-b border-slate-200 p-4 sm:flex-row sm:items-center sm:justify-between sm:p-5">
                <div class="flex w-full flex-col gap-3 sm:max-w-xl sm:flex-row">
                    <div class="relative w-full sm:flex-1">
                        <label for="purchase-order-search" class="sr-only">搜尋採購單</label>
                        <input
                            id="purchase-order-search"
                            type="search"
                            data-search
                            placeholder="搜尋單號、供應商或倉庫"
                    ...
                    <div class="w-full sm:w-40">
                        <label for="purchase-order-status-filter" class="sr-only">狀態篩選</label>
                        <select
            ...
            <div class="overflow-x-auto">
                <table class="min-w-[56rem] w-full divide-y divide-slate-200 text-left text-sm">
                    <thead class="bg-slate-50 text-slate-500">
                        <tr>
                            <th class="whitespace-nowrap px-4 py-3 font-medium sm:px-5">採購單號</th>
                            <th class="whitespace-nowrap px-4 py-3 font-medium sm:px-5">採購日期</th>
                            <th class="whitespace-nowrap px-4 py-3 font-medium sm:px-5">供應商</th>
                            <th class="whitespace-nowrap px-4 py-3 font-medium sm:px-5">進貨倉庫</th>
                            <th class="whitespace-nowrap px-4 py-3 font-medium sm:px-5 text-right">總金額</th>
        ...
        <div
            ...
            role="dialog"
            aria-modal="true"
            aria-labelledby="purchase-order-delete-dialog-title"
            aria-hidden="true"
        >
            ...
            <div class="relative w-full max-w-md rounded-xl border border-slate-200 bg-white p-5 shadow-xl sm:p-6">
                <h3 id="purchase-order-delete-dialog-title" class="text-lg font-semibold text-slate-900">確認刪除</h3>
