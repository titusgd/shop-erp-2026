<x-layouts.app active="districts">
    <x-slot:title>地區管理</x-slot:title>

    <div class="mx-auto max-w-6xl space-y-6" data-districts-page>
        <section class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div class="min-w-0">
                <h2 class="text-xl font-semibold tracking-tight text-slate-900 sm:text-2xl">地區管理</h2>
                <p class="mt-1 text-sm text-slate-500">建立與管理地區資料，每筆地區必須隸屬一個縣市。</p>
            </div>
            <a
        ...
        <section class="rounded-xl border border-slate-200 bg-white shadow-sm">
            <div class="flex flex-col gap-3 border-b border-slate-200 p-4 sm:flex-row sm:items-center sm:justify-between sm:p-5">
                <div class="relative w-full sm:max-w-xs">
                    <label for="district-search" class="sr-only">搜尋地區</label>
                    <input
                        id="district-search"
                        type="search"
                        data-search
                        placeholder="搜尋名稱、系統編號或縣市"
                ...
                <table class="min-w-[48rem] w-full divide-y divide-slate-200 text-left text-sm">
                    <thead class="bg-slate-50 text-slate-500">
                        <tr>
                            ...
                            <th class="whitespace-nowrap px-4 py-3 font-medium sm:px-5">縣市</th>
                            <th class="whitespace-nowrap px-4 py-3 font-medium sm:px-5">地區名稱</th>
        ...
        <div
            ...
            role="dialog"
            aria-modal="true"
            aria-labelledby="district-delete-dialog-title"
            aria-hidden="true"
        >
            ...
            <div class="relative w-full max-w-md rounded-xl border border-slate-200 bg-white p-5 shadow-xl sm:p-6">
                <h3 id="district-delete-dialog-title" class="text-lg font-semibold text-slate-900">確認刪除</h3>
    ...
    <x-slot:scripts>
        @vite('resources/js/districts.js')
    </x-slot:scripts>
</x-layouts.app>
