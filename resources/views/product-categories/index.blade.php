<x-layouts.app active="product-categories">
    <x-slot:title>商品分類管理</x-slot:title>

    <div class="mx-auto max-w-6xl space-y-6" data-product-categories-page>
        <section class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div class="min-w-0">
                <h2 class="text-xl font-semibold tracking-tight text-slate-900 sm:text-2xl">商品分類管理</h2>
                <p class="mt-1 text-sm text-slate-500">建立與管理商品分類，例如飲料、食品、日用品。</p>
            </div>
            <a
        ...
        <section class="rounded-xl border border-slate-200 bg-white shadow-sm">
            <div class="flex flex-col gap-3 border-b border-slate-200 p-4 sm:flex-row sm:items-center sm:justify-between sm:p-5">
                <div class="relative w-full sm:max-w-xs">
                    <label for="product-category-search" class="sr-only">搜尋商品分類</label>
                    <input
                ...
                <table class="min-w-[40rem] w-full divide-y divide-slate-200 text-left text-sm">
                    <thead class="bg-slate-50 text-slate-500">
                        <tr>
                            ...
                            <th class="whitespace-nowrap px-4 py-3 font-medium sm:px-5">分類名稱</th>
        ...
        <div
            ...
            role="dialog"
            aria-modal="true"
            aria-labelledby="product-category-delete-dialog-title"
            aria-hidden="true"
        >
            ...
            <div class="relative w-full max-w-md rounded-xl border border-slate-200 bg-white p-5 shadow-xl sm:p-6">
                <h3 id="product-category-delete-dialog-title" class="text-lg font-semibold text-slate-900">確認刪除</h3>
