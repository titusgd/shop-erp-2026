<x-layouts.app active="users">
    <x-slot:title>新增帳號</x-slot:title>

    <div
        class="mx-auto max-w-2xl space-y-6"
        data-user-create-page
        data-index-url="{{ route('users.index') }}"
    >
        <section class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div class="min-w-0">
                <h2 class="text-xl font-semibold tracking-tight text-slate-900 sm:text-2xl">新增帳號</h2>
                <p class="mt-1 text-sm text-slate-500">填寫帳號基本資料。</p>
            </div>
            <a
        ...
        <section class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:p-8">
            <form data-user-form class="space-y-4">
                ...
                <div>
                    <label for="user-password" class="mb-1.5 block text-sm font-medium text-slate-700">密碼</label>
                    <input
                        id="user-password"
                        name="password"
                        type="password"
