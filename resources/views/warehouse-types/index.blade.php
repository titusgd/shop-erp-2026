<x-layouts.app active="warehouse-types">
    <x-slot:title>倉庫類型管理</x-slot:title>

    <div class="mx-auto max-w-6xl space-y-6" data-warehouse-types-page>
        <section class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div class="min-w-0">
                <h2 class="text-xl font-semibold tracking-tight text-slate-900 sm:text-2xl">倉庫類型管理</h2>
                <p class="mt-1 text-sm text-slate-500">建立與管理倉庫類型，例如總倉、門市倉、退貨倉。</p>
            </div>
            <a
                href="{{ route('warehouse-types.create') }}"
                aria-label="新增倉庫類型"
                title="新增倉庫類型"
        ...
        <section class="rounded-xl border border-slate-200 bg-white shadow-sm">
            <div class="flex flex-col gap-3 border-b border-slate-200 p-4 sm:flex-row sm:items-center sm:justify-between sm:p-5">
                <div class="relative w-full sm:max-w-xs">
                    <label for="warehouse-type-search" class="sr-only">搜尋倉庫類型</label>
                    <input
                        id="warehouse-type-search"
                        type="search"
                        data-search
                        placeholder="搜尋名稱或系統編號"
                ...
                <table class="min-w-[40rem] w-full divide-y divide-slate-200 text-left text-sm">
                    <thead class="bg-slate-50 text-slate-500">
                        <tr>
                            ...
                            <th class="whitespace-nowrap px-4 py-3 font-medium sm:px-5">類型名稱</th>
                    ...
                    <tbody class="divide-y divide-slate-100" data-table-body>
                        <tr>
                            <td colspan="4" class="px-4 py-8 text-center text-slate-500 sm:px-5">載入中…</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div
            ...
            role="dialog"
            aria-modal="true"
            aria-labelledby="warehouse-type-delete-dialog-title"
            aria-hidden="true"
        >
            ...
            <div class="relative w-full max-w-md rounded-xl border border-slate-200 bg-white p-5 shadow-xl sm:p-6">
                <h3 id="warehouse-type-delete-dialog-title" class="text-lg font-semibold text-slate-900">確認刪除</h3>
    ...
    <x-slot:scripts>
        @vite('resources/js/warehouse-types.js')
    </x-slot:scripts>
</x-layouts.app>
