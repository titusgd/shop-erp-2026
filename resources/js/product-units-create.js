...
function initProductUnitCreatePage(root) {
...
const page = document.querySelector('[data-product-unit-create-page]');
if (page) {
    initProductUnitCreatePage(page);
}
