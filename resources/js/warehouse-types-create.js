...
function initWarehouseTypeCreatePage(root) {
...
const page = document.querySelector('[data-warehouse-type-create-page]');
if (page) {
    initWarehouseTypeCreatePage(page);
}
