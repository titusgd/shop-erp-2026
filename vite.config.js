    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/js/purchase-requisitions.js',
                'resources/js/purchase-requisitions-create.js',
                'resources/js/purchase-requisitions-edit.js',
                'resources/js/purchase-requisitions-show.js',
                'resources/js/purchase-orders.js',
                'resources/js/purchase-orders-create.js',
                'resources/js/purchase-orders-edit.js',
                'resources/js/purchase-orders-show.js',
